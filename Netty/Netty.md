...
最终输出：消息长度为288个字节，后续消息正文刚好288字节

<img src="Netty.assets/image-20230417103252875.png" alt="image-20230417103252875" style="zoom:80%;" />

测试decode方法，能够正确地读取消息内容
...
输出：
10:37:38.970 [main] DEBUG com.java.netty.demo01.nettyadvanced.net4.protocol.MessageCodec - magicNumber: 16909060, version: 1, serializerType: 0, messageType: 0, sequenceId: 0, length: 288
10:37:38.974 [main] DEBUG com.java.netty.demo01.nettyadvanced.net4.protocol.MessageCodec - content: LoginRequestMessage(super=Message(sequenceId=0, messageType=0), username=zhangsan, password=123456, nickname=张三)
```
